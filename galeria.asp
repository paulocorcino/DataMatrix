...
%></td>
    ...
    <td width="587" colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="3">
      ...
      <tr>
		...
		<p class="titulo_areas">Galeria de Fotos</p>
  ...
  <tr>
    <td width="5%" rowspan="2" align="center" valign="middle"><img src="fotos/<%=rs("foto")%>" alt="" name="imgnot" id="imgnot" /></td>
    <td><span class="texto_1"><a href="album.asp?id=<%=rs("cod")%>"><%=rs("album")%></a></span>&nbsp;</td>
  </tr>
  <tr>
    <td><span class="texto_2"><%=rs("data")%><br /><%=rs("comentario")%></span>&nbsp;</td>
  </tr>
</table>
