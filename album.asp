	  ...
	  <tr>
		...
		<table width="90%" border="0" align="center" cellpadding="0" cellspacing="3" class="table_submaster">
          <tr class="titulos_sub">
            <td colspan="3">Tempo Hoje<div id="temMin"></div> </td>
          </tr>
          <tr>
...
%></td>
    ...
    <td width="587" colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="3">
      ...
      <tr>
		...
		<!-- InstanceBeginEditable name="Conteudo" --><span class="titulo_areas">&Aacute;lbum</span>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="350" colspan="3" align="center" valign="middle"><div id="aAlbumShowFoto">&nbsp;</div></td>
  </tr>
  <tr>
    <td colspan="3" align="center"><div id="aAlbumNomeFoto" style="display:none"></div>      <div id="aAlbumClick"  style="display:none">cliques</div>      
      <div id="aAlbumEnviar">&nbsp;<a href="#">enviar para amigo</a> </div></td>
    </tr>
  <tr>
    <td colspan="3"><div id="aAlbumThumb">&nbsp;</div></td>
  </tr>
  <tr>
    <td width="33%"><div id="aAlbumVoltar">&lt;&nbsp;voltar</div></td>
    <td width="33%" align="center"><div id="aAlbumListPage">&nbsp;</div></td>
    <td width="33%" align="right"><div id="aAlbumAvancar">&nbsp;Avan&ccedil;ar &gt; </div></td>
  </tr>
</table>
