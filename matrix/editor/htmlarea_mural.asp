...
/*		[ "fontname", "space",
		...
		[ "copy", "cut", "paste",  "separator", "bold", "italic", "underline","separator",
		  "subscript", "superscript", "separator","emoticon"]
		/*"fontname", "space",*/
	...
	this.btnList = {
		...
		emoticon: [ "Emoticons", "ed_emo.gif", true, function(e) {e.execCommand("emoticon");} ],
...
HTMLArea.prototype.generate = function () {
	...
	function initIframe() {
		...
		if (!editor.config.fullPage) {
			...
			html += "<style> html,body { border: 0px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; } " +
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
		...
		case "emoticon":
			//window.open(_editor_url + 'emoticom.asp','emoticon','status=1,width=300,height=200');
			MM_showHideLayers('emoticon','','show');
		break;
