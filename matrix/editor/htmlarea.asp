...
/*		[ "fontname", "space",
		...
		[ "fontsize","separator","copy", "cut", "paste",  "separator", /*"undo", "redo", "separator",*/"createlink", "insertimage", "inserttable", "htmlmode", "separator",  "space","bold", "italic", "underline",/* "strikethrough",*/ "separator",
		  "subscript", "superscript", "separator","justifyleft", "justifycenter", "justifyright", "justifyfull", "separator","insertorderedlist", "insertunorderedlist", "outdent", "indent", "separator",
		  "forecolor", "hilitecolor","about"]
		/*"fontname", "space",*/
	...
	this.btnList = {
		...
		insertorderedlist: [ "Lista Ordenada", "ed_list_num.gif", false, function(e) {e.execCommand("insertorderedlist");} ],
		insertunorderedlist: [ "Marcadores", "ed_list_bullet.gif", false, function(e) {e.execCommand("insertunorderedlist");} ],
		outdent: [ "Decrease Indent", "ed_indent_less.gif", false, function(e) {e.execCommand("outdent");} ],
		indent: [ "Increase Indent", "ed_indent_more.gif", false, function(e) {e.execCommand("indent");} ],
		forecolor: [ "Font Color", "ed_color_fg.gif", false, function(e) {e.execCommand("forecolor");} ],
		hilitecolor: [ "Background Color", "ed_color_bg.gif", false, function(e) {e.execCommand("hilitecolor");} ],
		inserthorizontalrule: [ "Linha Horizontal", "ed_hr.gif", false, function(e) {e.execCommand("inserthorizontalrule");} ],
...
HTMLArea.prototype.generate = function () {
	...
	function initIframe() {
		...
		if (!editor.config.fullPage) {
			...
			html += "<style> html,body { border: 0px; font-family: Verdana, Arial, Helvetica, sans-serif; } " +
...
HTMLArea.prototype._insertImage = function(image) {
	...
	if (image) outparam = {
		...
		f_float  : image.style.float
	};
	this._popupDialog("insert_image.asp?area=<%=request.QueryString("tela")%>&id=<%=request.QueryString("id")%>", function(param) {
		...
		if (!img) {
			...
			//editor._doc.execCommand("insertimage", true, param.f_float);
			if (HTMLArea.is_ie) {
		...
		for (field in param) {
			...
			switch (field) {
				...
				case "f_float"  : img.style.float = value; break;
			    case "f_vert"   : img.vspace = parseInt(value || "0"); break;
			    case "f_horiz"  : img.hspace = parseInt(value || "0"); break;
				//case "f_float"  : img.style = value; break;
