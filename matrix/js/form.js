...
var i;
   ...
   /* Error-message if err != 0 */
      ...
      alert("Esta data é inválida. Verifique!");
        //DateField.focus();
		//DateField.select();
		DateField.value = data_hoje();
   }
}
...
function dataVal(i){
	...
	if(n.length==0){
		...
		if(n.length<10){
			alert("Você deve inserir uma data válida!\nEx.:" + data_hoje());
			vl.value = data_hoje();		
			//vl.focus();
			//vl.select();
		}else{
...
function opView(n){
			...
			var elem = document.getElementById("op"+n);
			if(null != elem)
				{
		...
		switch(n){
			case '1':
				document.getElementById("op2").className = "collapsed";	
				document.getElementById("op3").className = "collapsed";
				document.getElementById("op4").className = "collapsed";
				document.getElementById("dataIni").disabled = false ;
				document.getElementById("dataFim").disabled = false;
				document.getElementById("sMes").disabled = true;
				document.getElementById("sAno").disabled = true;
				document.getElementById("sAnoAno").disabled = true;
				document.getElementById("sPeriodo").disabled = true;
				break;	
			case '2':
				document.getElementById("op1").className = "collapsed";	
				document.getElementById("op3").className = "collapsed";
				document.getElementById("op4").className = "expanded";			
				document.getElementById("dataIni").disabled = true ;
				document.getElementById("dataFim").disabled = true;
				document.getElementById("sMes").disabled = false;
				document.getElementById("sAno").disabled = false;
				document.getElementById("sAnoAno").disabled = true;
				document.getElementById("sPeriodo").disabled = false;
				break;
			case  '3':
				document.getElementById("op1").className = "collapsed";	
				document.getElementById("op2").className = "collapsed";
				...
				document.getElementById("sMes").disabled = true;
				document.getElementById("sAno").disabled = true;
				document.getElementById("sAnoAno").disabled = false;
				document.getElementById("sPeriodo").disabled = false;
				break;
		}
	}
	
	function listDefVal(obj){
		
		var n = obj.options.length
		
		if(n<1){
			addOption(obj,"* Todos os itens",0,false)
		}else{
	...
	function limitAdd(obj, o){
		var n = obj.options.length
		if(n>1){
			document.forms[0].tpP[1].disabled = true;
			document.forms[0].tpP[2].disabled = true;
			document.forms[0].tpP[0].checked = true;
			document.getElementById("op1").className = "expanded";
			document.getElementById("dataIni").disabled = false;
			document.getElementById("dataFim").disabled = false;
			document.getElementById("sMes").disabled = true;
			document.getElementById("sAno").disabled = true;
			...
			document.forms[0].tpP[1].disabled = false;
			document.forms[0].tpP[2].disabled = false;
			//alert(n + "i");
		}
